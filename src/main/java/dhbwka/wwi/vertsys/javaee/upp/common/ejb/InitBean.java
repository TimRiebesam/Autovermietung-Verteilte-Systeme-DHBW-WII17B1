...
public class InitBean {
    ...
    private void loadAutosIntoDatabase(){
        Auto auto = new Auto("VW", "Golf", "L 4.258 mm <br>B 1.790 mm <br>H 1.492 mm", "Kleinwagen", "Benzin", 5, 4, "Automatik", 12034, 55, "https://cdn.meinauto.de/car-pics/___Pix-NoBrand/VOLKSWAGEN/GOLF/7/5Hatchback%20Comfortline/volkswagen_17golfcomfort5ha7fb_angularfront_nb-298.jpg");
        autoBean.saveAuto(auto);
        
        autoBean.saveAuto(new Auto("Ford", "Transit", "L 4.973 mm <br>B 1.986 mm <br>H 2.000 mm", "Transporter", "Diesel", 3, 4, "Automatik", 16344, 90, "https://www.meinauto.de/pics/auto_neuwagen/ford-transit-custom-kastenwagen-298.jpg"));
        autoBean.saveAuto(new Auto("Porsche", "911", "L 4.519 mm <br>B 1.852 mm <br>H 1.300 mm", "Sportwagen", "Benzin", 2, 2, "Automatik", 4020, 150, "https://cdn.meinauto.de/car-pics/___Pix-NoBrand/PORSCHE/911/7/2Coupe%20CarreraS/porsche_17911carrerasco7fa_angularfront_nb-298.jpg"));
        ...
        Buchung buchung = new Buchung(auto, userBean.getCurrentUser(), "", new Date(), new Date(), 0, "");
        buchungBean.saveBuchung(buchung);
        rueckgabeBean.saveNew(new Rueckgabe(buchung, "keine", "KA Mitte", 6, 4, "Alles TipTop"));
    }
