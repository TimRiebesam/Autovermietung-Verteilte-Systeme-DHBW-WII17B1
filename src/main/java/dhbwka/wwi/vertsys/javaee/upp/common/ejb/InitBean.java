...
public class InitBean {
    ...
    private void loadAutosIntoDatabase(){
        autoBean.saveAuto(new Auto("VW", "Golf", "L 4.258 mm <br>B 1.790 mm <br>H 1.492 mm", "Kleinwagen", "Benzin", 5, 4, "Automatik", 12034, 55, "https://cdn.meinauto.de/car-pics/___Pix-NoBrand/VOLKSWAGEN/GOLF/7/5Hatchback%20Comfortline/volkswagen_17golfcomfort5ha7fb_angularfront_nb-298.jpg"));
